...
async def main_async():
    ...
    invalid_device = BLEDevice()
    invalid_device.Name = "FAKE_DEVICE"
    invalid_device.Address = "00:00:00:00:00:00"
    invalid_sensor = ctrl.requireSensor(invalid_device)
    if invalid_sensor is None:
        print("[异步连接-失败] requireSensor(无效设备) 返回 None，无法继续测试", flush=True)
